...
package com.smk.cpp.sts.core.resolver;
...
public class SmkLocaleResolver implements LocaleResolver {
    ...
    public Locale resolveLocale(HttpServletRequest request) {
        ...
        if (StringUtils.hasText(language) && language.indexOf(IConstants.REGEX_UNDERLINE) > 0) {
            String[] languages = language.split(IConstants.REGEX_UNDERLINE);
        ...
        logger.debug("i18n current language value is {}", locale.getLanguage());
        return locale;
    }
