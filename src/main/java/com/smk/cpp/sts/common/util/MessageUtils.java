...
public class MessageUtils {
    ...
    public static String getMessage(String key){
        try {
            ...
            logger.debug("get message error:key is {}" , key);
    ...
    public static String getMessage(String key, String defaultMessage){
        try {
            ...
            logger.debug("get message error:key is {}" , key);
            logger.debug("get message error:defaultMessage is {}" , defaultMessage);
            logger.debug("get message error:message is {} , cause is {}" , e.getMessage() , e.getCause());
            return "message undefined";
        }
    }
    ...
    public static String getMessage(String key, Object[] objects){
        try {
            ...
            logger.debug("get message error:key is {}" , key);
            logger.debug("get message error:objects is {}" , objects);
            logger.debug("get message error:message is {} , cause is {}" , e.getMessage() , e.getCause());
            return "message undefined";
        }
